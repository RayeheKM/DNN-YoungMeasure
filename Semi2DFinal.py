...
def visualize_model_updated_minibatch(model, loss_history, term1_history, term2_history, term3_history, termc_history, x, y, z, w):
    ...
    plt.savefig('Semi2D_loss.png')  # Save the figure
    plt.close()  # Close the figure

    savemat('Semi2D_loss_data.mat', {
    ...
    for i, (x_fixed, y_fixed) in enumerate(fixed_points):
        ...
        plt.savefig(f'Semi2D_3d_F_x{x_fixed}_y{y_fixed}.png')  # Save each subplot
...
torch.save(trained_model.state_dict(), "model_parametersSemi2D.pth")

# To load the model parameters from a file
trained_model.load_state_dict(torch.load("model_parametersSemi2D.pth"))
